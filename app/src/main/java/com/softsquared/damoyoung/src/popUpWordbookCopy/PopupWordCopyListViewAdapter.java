...
public class PopupWordCopyListViewAdapter extends BaseAdapter {

    private ArrayList<PopupWordCopyListViewItem> mLvBookmarkItems;
    LayoutInflater mInflater;
    Context mContext;

    // ListViewAdapter의 생성자
    public PopupWordCopyListViewAdapter(ArrayList<PopupWordCopyListViewItem> items, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final PopupWordCopyListViewItem popupBookmarkListViewItem = mLvBookmarkItems.get(position);
        if (convertView == null) {
...
//                    }
    ...
    public ArrayList<PopupWordCopyListViewItem> getMainItem() {
